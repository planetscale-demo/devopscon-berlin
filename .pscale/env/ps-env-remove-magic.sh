...
export DEPLOY_REQUEST_NUMBER="8"
echo "::set-output name=DEPLOY_REQUEST_NUMBER::8"

export DEPLOY_REQUEST_URL="https://app.planetscale.com/planetscale-demo/harry-potter-jonico/deploy-requests/8"
echo "::set-output name=DEPLOY_REQUEST_URL::https://app.planetscale.com/planetscale-demo/harry-potter-jonico/deploy-requests/8"
